package cn.shop.com.business.tbcarousel.controller;
...
import cn.shop.com.business.tbcarousel.service.TbCarouselService; 
 ...
 */
@Controller
@RequestMapping(value="/tbCarouselController")
public class TbCarouselController extends BaseController {
	...
	public ModelAndView list(Page page){
		...
		try{
			pd = this.getPageData();
			page.setPd(pd);
			List<PageData>	varList = tbCarouselService.list(page);	//列出TProductController列表
			mv.setViewName("information/tbcarousel/tbcarousel_list");
	...
	public ModelAndView goEdit(){
		...
		try {
			...
			mv.setViewName("information/tbcarousel/tbcarousel_edit");
