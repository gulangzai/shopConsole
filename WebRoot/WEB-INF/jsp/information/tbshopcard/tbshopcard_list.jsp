...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="${ctx}/tbShopcardController/list.do" method="post" name="Form" id="Form">
			<table>
				<tr>
					<td>
			...
			<table id="table_report" class="table table-striped table-bordered table-hover imagetable">
				...
				<thead>
					<tr>
						...
						<th class="center"   width="8%">订单编号</th>
						<th class="center"  width="12%">用户名</th>
						<th class="center"  width="12%">手机号</th>
						<th class="center"  width="12%">商品名</th>
						<th class="center"  width="25%">商品介绍</th>
