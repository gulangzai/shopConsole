						...
						<c:forEach items="${varList}" var="var" varStatus="vs">
							<tr>
								<td class='center' style="width: 30px;">
									<label><input type='checkbox' name='ids' value="${var.F_PRODUCT_ID}" /><span class="lbl"></span></label>
								</td>
								<td class='center' style="width: 30px;">${vs.index+1}</td>
										...
										<td  style="text-align:center"><c:if test="${var.F_ISSPECIAL=='0'}">是</c:if><c:if test="${var.F_ISSPECIAL=='1'}">否</c:if></td>
										
							   <td  class="center" style="width:50px;">   
									 <a style="cursor:pointer;" title="编辑" onclick="edit('${var.F_PRODUCT_ID}');" class="tooltip-success" data-rel="tooltip" title="" data-placement="left"><span class="green"><i class="icon-edit"></i></span></a> 
								     <a style="cursor:pointer;" title="删除" onclick="del('${var.F_PRODUCT_ID}');" class="tooltip-error" data-rel="tooltip" title="" data-placement="left"><span class="red"><i class="icon-trash"></i></span> </a> 
								</td>  
							</tr>
	...
	<!-- PAGE CONTENT ENDS HERE -->
       ...
       <script type="text/javascript">
		...
		function edit(Id){
			 ...
			 diag.Drag=true;
			 diag.Title ="编辑";
			 diag.URL = '${ctx}/tbProductController/goEdit.do?F_PRODUCT_ID='+Id;
			 diag.Width =850;
			 diag.Height =655;
			 diag.CancelEvent = function(){ //关闭事件
				 if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
